...
abstract class BaseUsers extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|Userdetails[] Collection to store aggregation of Userdetails objects.
     */
    protected $collUserdetailss;
    protected $collUserdetailssPartial;
     ...
     */
    protected $userdetailssScheduledForDeletion = null;
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->userdetailssScheduledForDeletion !== null) {
                if (!$this->userdetailssScheduledForDeletion->isEmpty()) {
                    foreach ($this->userdetailssScheduledForDeletion as $userdetails) {
                        // need to save related object because we set the relation to null
                        $userdetails->save($con);
                    }
                    $this->userdetailssScheduledForDeletion = null;
                }
            }

            if ($this->collUserdetailss !== null) {
                foreach ($this->collUserdetailss as $referrerFK) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collUserdetailss) {
                $result['Userdetailss'] = $this->collUserdetailss->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getUserdetailss() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addUserdetails($relObj->copy($deepCopy));
                }
            }
    ...
    {
        if ('Userdetails' == $relationName) {
            $this->initUserdetailss();
        }
    }

    /**
     * Clears out the collUserdetailss collection
     *
     ...
     * @see        addUserdetailss()
     */
    public function clearUserdetailss()
    {
        $this->collUserdetailss = null; // important to set this to null since that means it is uninitialized
        $this->collUserdetailssPartial = null;

        return $this;
    }

    /**
     * reset is the collUserdetailss collection loaded partially
     *
     * @return void
     */
    public function resetPartialUserdetailss($v = true)
    {
        $this->collUserdetailssPartial = $v;
    }

    /**
     * Initializes the collUserdetailss collection.
     *
     * By default this just sets the collUserdetailss collection to an empty array (like clearcollUserdetailss());
     ...
     * @return void
     */
    public function initUserdetailss($overrideExisting = true)
    {
        if (null !== $this->collUserdetailss && !$overrideExisting) {
            return;
        }
        $this->collUserdetailss = new PropelObjectCollection();
        $this->collUserdetailss->setModel('Userdetails');
    }

    /**
     * Gets an array of Userdetails objects which contain a foreign key that references this object.
     *
     ...
     * @return PropelObjectCollection|Userdetails[] List of Userdetails objects
     * @throws PropelException
     */
    public function getUserdetailss($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collUserdetailssPartial && !$this->isNew();
        if (null === $this->collUserdetailss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collUserdetailss) {
                // return empty collection
                $this->initUserdetailss();
            } else {
                $collUserdetailss = UserdetailsQuery::create(null, $criteria)
                    ->filterByUsers($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collUserdetailssPartial && count($collUserdetailss)) {
                      $this->initUserdetailss(false);

                      foreach ($collUserdetailss as $obj) {
                        if (false == $this->collUserdetailss->contains($obj)) {
                          $this->collUserdetailss->append($obj);
                        }
                      }

                      $this->collUserdetailssPartial = true;
                    }

                    $collUserdetailss->getInternalIterator()->rewind();

                    return $collUserdetailss;
                }

                if ($partial && $this->collUserdetailss) {
                    foreach ($this->collUserdetailss as $obj) {
                        if ($obj->isNew()) {
                            $collUserdetailss[] = $obj;
                        }
                    }
                }

                $this->collUserdetailss = $collUserdetailss;
                $this->collUserdetailssPartial = false;
            }
        }

        return $this->collUserdetailss;
    }

    /**
     * Sets a collection of Userdetails objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $userdetailss A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Users The current object (for fluent API support)
     */
    public function setUserdetailss(PropelCollection $userdetailss, PropelPDO $con = null)
    {
        $userdetailssToDelete = $this->getUserdetailss(new Criteria(), $con)->diff($userdetailss);


        $this->userdetailssScheduledForDeletion = $userdetailssToDelete;

        foreach ($userdetailssToDelete as $userdetailsRemoved) {
            $userdetailsRemoved->setUsers(null);
        }

        $this->collUserdetailss = null;
        foreach ($userdetailss as $userdetails) {
            $this->addUserdetails($userdetails);
        }

        $this->collUserdetailss = $userdetailss;
        $this->collUserdetailssPartial = false;
    ...
    /**
     * Returns the number of related Userdetails objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related Userdetails objects.
     * @throws PropelException
     */
    public function countUserdetailss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collUserdetailssPartial && !$this->isNew();
        if (null === $this->collUserdetailss || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collUserdetailss) {
            ...
            if ($partial && !$criteria) {
                return count($this->getUserdetailss());
            }
            $query = UserdetailsQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collUserdetailss);
    }

    /**
     * Method called to associate a Userdetails object to this object
     * through the Userdetails foreign key attribute.
     *
     * @param    Userdetails $l Userdetails
     * @return Users The current object (for fluent API support)
     */
    public function addUserdetails(Userdetails $l)
    {
        if ($this->collUserdetailss === null) {
            $this->initUserdetailss();
            $this->collUserdetailssPartial = true;
        ...
        if (!in_array($l, $this->collUserdetailss->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddUserdetails($l);

            if ($this->userdetailssScheduledForDeletion and $this->userdetailssScheduledForDeletion->contains($l)) {
                $this->userdetailssScheduledForDeletion->remove($this->userdetailssScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	Userdetails $userdetails The userdetails object to add.
     */
    protected function doAddUserdetails($userdetails)
    {
        $this->collUserdetailss[]= $userdetails;
        $userdetails->setUsers($this);
    }

    /**
     * @param	Userdetails $userdetails The userdetails object to remove.
     * @return Users The current object (for fluent API support)
     */
    public function removeUserdetails($userdetails)
    {
        if ($this->getUserdetailss()->contains($userdetails)) {
            $this->collUserdetailss->remove($this->collUserdetailss->search($userdetails));
            if (null === $this->userdetailssScheduledForDeletion) {
                $this->userdetailssScheduledForDeletion = clone $this->collUserdetailss;
                $this->userdetailssScheduledForDeletion->clear();
            }
            $this->userdetailssScheduledForDeletion[]= $userdetails;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collUserdetailss) {
                foreach ($this->collUserdetailss as $o) {
        ...
        if ($this->collUserdetailss instanceof PropelCollection) {
            $this->collUserdetailss->clearIterator();
        }
        $this->collUserdetailss = null;
    }
