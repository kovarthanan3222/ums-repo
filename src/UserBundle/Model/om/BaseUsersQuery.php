 ...
 *
 * @method UsersQuery leftJoinUserdetails($relationAlias = null) Adds a LEFT JOIN clause to the query using the Userdetails relation
 * @method UsersQuery rightJoinUserdetails($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Userdetails relation
 * @method UsersQuery innerJoinUserdetails($relationAlias = null) Adds a INNER JOIN clause to the query using the Userdetails relation
 *
...
abstract class BaseUsersQuery extends ModelCriteria
{
    ...
    public function filterByUserdetails($userdetails, $comparison = null)
    {
        if ($userdetails instanceof Userdetails) {
            return $this
                ->addUsingAlias(UsersPeer::ID, $userdetails->getUserId(), $comparison);
     ...
     * @return UsersQuery The current query, for fluid interface
     */
    public function joinUserdetails($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \UserBundle\Model\UserdetailsQuery A secondary query class using the current class as primary query
     */
    public function useUserdetailsQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinUserdetails($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Userdetails', '\UserBundle\Model\UserdetailsQuery');
    }
