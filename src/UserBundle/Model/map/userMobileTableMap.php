...
/**
 * This class defines the structure of the 'userMobile' table.
 *
 *
 *
 ...
 */
class userMobileTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.UserBundle.Model.map.userMobileTableMap';
    ...
    {
        // attributes
        $this->setName('userMobile');
        $this->setPhpName('userMobile');
        $this->setClassname('UserBundle\\Model\\userMobile');
