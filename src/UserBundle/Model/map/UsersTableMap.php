...
class UsersTableMap extends TableMap
{
    ...
    {
        $this->addRelation('userEmail', 'UserBundle\\Model\\userEmail', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null, 'userEmails');
        $this->addRelation('userMobile', 'UserBundle\\Model\\userMobile', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null, 'userMobiles');
    } // buildRelations()
