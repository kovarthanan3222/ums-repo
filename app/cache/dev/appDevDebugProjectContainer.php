...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ums', 'user' => 'root', 'password' => 'console', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ec0d1e18ef7c7936aebb2b33153dba89cc5b193bdec62b94094862291fc1e0e8');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Propel\Bundle\PropelBundle\Form\PropelTypeGuesser A Propel\Bundle\PropelBundle\Form\PropelTypeGuesser instance.
     */
    protected function getForm_TypeGuesser_PropelService()
    {
        return $this->services['form.type_guesser.propel'] = new \Propel\Bundle\PropelBundle\Form\PropelTypeGuesser();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Propel\Bundle\PropelBundle\DataCollector\PropelDataCollector($this->get('propel.logger'), $this->get('propel.configuration')));
        $instance->add($d);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Propel\Bundle\PropelBundle\DependencyInjection\Properties A Propel\Bundle\PropelBundle\DependencyInjection\Properties instance.
     */
    protected function getPropel_BuildPropertiesService()
    {
        return $this->services['propel.build_properties'] = new \Propel\Bundle\PropelBundle\DependencyInjection\Properties(array());
    }
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=localhost;dbname=ums;charset=UTF8', 'user' => 'root', 'password' => 'console', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array())))));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fc0ef0fc817833f15dd1dff3cef1ad9c1718d25b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5705fea05fbd79.85154371')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'fc0ef0fc817833f15dd1dff3cef1ad9c1718d25b',
            'locale' => 'en',
            ...
            'kernel.secret' => 'fc0ef0fc817833f15dd1dff3cef1ad9c1718d25b',
            ...
            'propel.build_properties.class' => 'Propel\\Bundle\\PropelBundle\\DependencyInjection\\Properties',
            ...
            'form.type_guesser.propel.class' => 'Propel\\Bundle\\PropelBundle\\Form\\PropelTypeGuesser',
